const codeJudgeService = require('../services/codeJudgeService');
...
class SubmissionController {
  ...
  async getSubmissionStatus(req, res, next) {
    try {
      ...
      const status = await codeJudgeService.getSubmissionStatus(submissionId);
  ...
  formatEvaluationResponse(result) {
