        ...
        {activeTab === 'users' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <UsersTab currentUserRoles={currentUserRoles} />
            </div>

            {/* Right column: CSV upload + Format + Status */}
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900">Estado de Usuarios</h2>
                ...
                {isLoadingStatus ? (
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-gray-50 rounded-lg flex items-center justify-between">
                      ...
                      <span className="text-xl font-bold text-gray-900">{userStatus.total}</span>
                    </div>
                    <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xl font-bold text-green-900">{userStatus.enabled}</span>
                      </div>
                      <div className="w-full bg-green-200 rounded-full h-1.5">
                        <div className="bg-green-600 h-1.5 rounded-full transition-all" style={{ width: `${(userStatus.enabled / userStatus.total) * 100}%` }} />
                      </div>
                    </div>
                    <div className="p-3 bg-red-50 rounded-lg border border-red-200">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xl font-bold text-red-900">{userStatus.disabled}</span>
                      </div>
                      <div className="w-full bg-red-200 rounded-full h-1.5">
                        <div className="bg-red-600 h-1.5 rounded-full transition-all" style={{ width: `${(userStatus.disabled / userStatus.total) * 100}%` }} />
                      </div>
                    </div>
                    <button onClick={loadUserStatus} className="w-full py-2 px-4 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium transition-colors">
                      Actualizar
                    </button>
                  </div>
                ) : (
